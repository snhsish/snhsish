...
<img src="https://skillicons.dev/icons?i=nix,ts,git,nextjs,nodejs,bun,tailwind,express,react,redux,svelte,threejs,discordjs,supabase,mongodb,mysql,redis,planetscale,postgres,postman,prisma,js,python,go,c,cpp,rust,bash,java,html,css,linux,electron,github,npm,pnpm,yarn,bootstrap,neovim,vscode,azure,aws,gcp,vercel,workers,cloudflare,netlify,firebase,sentry,arduino,raspberrypi,blender,figma,discord,godot&perline=11" />
